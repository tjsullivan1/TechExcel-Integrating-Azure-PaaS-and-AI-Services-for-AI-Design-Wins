...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a particular hotel.")]
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a specified hotel on a specified date.")]
    ...
    [KernelFunction]
    [Description("Get all bookings that do not have a hotel room.")]
